...
3. Run "convertVGG.py" to convert VGG-Net from Caffe to TensorFlow format.
4. Run "visualizeVGG.py" to produce per-class images (total 1000 images for 1000 ImageNet categories) that the network wants to see.
